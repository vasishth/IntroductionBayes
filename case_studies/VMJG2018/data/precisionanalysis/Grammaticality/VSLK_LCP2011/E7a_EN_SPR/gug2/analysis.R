...
## question responses
alldataq <- read.table("allquestionsgug2.txt")
...
## gram: pos 6,7,8,9
## ungram 6 7 8
data <- read.table("alldatagug2.txt")
...
## post-V1
(fm.postv1 <- lmer(log(rt)~condition+(1|subj)+(1|item),subset(gram,(condition=="c" & pos==9) | (condition=="d" & pos==8)  & rt<2000)))
