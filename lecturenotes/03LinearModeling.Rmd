...
This prior predictive distribution in Figure \ref{fig:m1priorpred} shows that the prior for $\mu$ is not realistic: how can button press time have negative values?
